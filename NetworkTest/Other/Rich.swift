...
extension String {
    public static func +(lhs:String, rhs:[NSAttributedStringKey : Any]) -> NSAttributedString {
        return NSAttributedString(string: lhs, attributes: rhs)
    }
    
    public static func +(lhs:String, rhs:[NSAttributedStringKey]) -> NSAttributedString {
